  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        >
          <a href="tel:+79995109840" className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-white/20 bg-black font-semibold text-lg text-white hover:bg-white/10 transition-all hover:scale-105">
            Вызвать мастера
          </a>
          <a
            ...
            className="inline-flex items-center gap-2 px-8 py-4 rounded-full border border-white/20 bg-black font-semibold text-lg text-white hover:bg-white/10 transition-all hover:scale-105"
          >
