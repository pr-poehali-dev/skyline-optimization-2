...
const prices = [
  {
    ...
    items: [
      ...
      { name: "Замена помпы", price: "от 1 800 ₽" },
      { name: "Замена ТЭНа", price: "от 1 500 ₽" },
      { name: "Замена модуля управления", price: "от 3 000 ₽" },
    ],
  },
  {
    ...
    items: [
      { name: "Диагностика", price: "Бесплатно", note: "при заказе ремонта" },
      { name: "Устранение протечки", price: "от 1 500 ₽" },
      { name: "Замена помпы", price: "от 2 000 ₽" },
  ...
  },
  {
    ...
    items: [
      { name: "Диагностика", price: "Бесплатно", note: "при заказе ремонта" },
      { name: "Ремонт кофемашины", price: "от 1 200 ₽" },
      { name: "Ремонт пылесоса", price: "от 800 ₽" },
      { name: "Ремонт микроволновки", price: "от 1 000 ₽" },
      { name: "Ремонт утюга", price: "от 500 ₽" },
    ],
  },
]
